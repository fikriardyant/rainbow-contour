...
<head>
    ...
    <style>
        ...
        .font-cad-mono {{
            font-family: 'Consolas', 'Courier New', 'ISOCPEUR', monospace;
            letter-spacing: -0.02em;
        }}
        .font-cad-title {{
            font-family: 'Arial Narrow', 'ISOCPEUR', 'Arial', sans-serif;
...
<body class="bg-slate-100 p-4 font-cad-title text-slate-900 flex justify-center items-center min-h-screen">
    ...
    <div id="pdf-kop-container" class="w-[1123px] h-[794px] bg-white map-frame flex relative p-3 gap-3 shadow-2xl overflow-hidden">
        ...
        <div class="flex-1 flex flex-col relative border-2 border-slate-900">
            ...
            <div class="h-5 bg-slate-200 border-b border-slate-900 flex justify-between px-10 items-center text-[9px] font-cad-mono font-bold text-slate-700">
                <span>273000 mE</span>
            ...
            <div class="flex-1 flex relative">
                ...
                <div class="w-10 bg-slate-200 border-r-2 border-slate-900 flex flex-col justify-between py-12 px-1 items-center text-[9px] font-cad-mono font-bold text-slate-700 select-none">
            ...
            <div class="h-5 bg-slate-200 border-t border-slate-900 flex justify-between px-10 items-center text-[9px] font-cad-mono font-bold text-slate-700">
                <span>273000 mE</span>
                <span>115°27'00"E</span>
                <span>274000 mE</span>
                <span>115°27'30"E</span>
        ...
        <div class="w-[280px] border-2 border-slate-900 flex flex-col justify-between p-3 bg-white text-slate-900">
            ...
            <div class="bg-slate-100 border-2 border-slate-900 p-2 space-y-1 font-cad-mono">
                <h3 class="font-black text-[10px] uppercase text-slate-900 border-b border-slate-900 pb-0.5 font-cad-title">VOLUME SUMMARY</h3>
                <div class="flex justify-between items-center text-xs">
                    <span class="font-bold text-red-600 font-cad-title">CUT:</span>
