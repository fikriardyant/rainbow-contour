...
pub fn generate_html_viewer(title: &str, _grid: &[GridPointDelta], summary: &VolumeSummary) -> String {
    format!(
        r#"<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="bg-amber-50 p-6 font-sans text-slate-900">
    <div class="max-w-7xl mx-auto space-y-6">
        <header class="neo-box bg-yellow-300 border-4 border-slate-900 p-4 flex justify-between items-center">
        ...
        title, title, summary.cut_m3, summary.fill_m3, summary.net_m3
    )
}
